    ...
    <div class="header-top">
        <div class="container">
            ...
            <div class="header-left">
                <ul>
                    <li><a class="lock" href="${pageContext.request.contextPath}/uam/locLogin.action">Login</a></li>
                    <li><a class="lock" href="${pageContext.request.contextPath}/uam/locRegist.action">Register</a></li>
                    <li></li>
                </ul>
                    ...
                    <a href="${pageContext.request.contextPath}/checkout.jsp">
                        <h3>
                            <div class="total">
                                ...
                                </span> (<span id="simpleCart_quantity" class="simpleCart_quantity"></span>items)
                            </div>
            ...
            <div class=" h_menu4">
                <ul class="memenu skyblue">
                    <li class="active grid">
                        <a class="color8" href="${pageContext.request.contextPath}/index.jsp">Home</a>
                    </li>
    ...
    <div class=" register">
        ...
        <form method="post" action="${pageContext.request.contextPath}/uam/regist.action" onsubmit="return submitForm();">
            <div class="col-md-6 register-top-grid">
                ...
                <div>
                    <span>User Name</span>
                    <input type="text" name="userDto.userName" id="userName">
                </div>
                <div>
                ...
                <a class="news-letter" href="#">
                    <label class="checkbox">
                        ...
                        <i> </i>Sign Up for Newsletter</label> </a>
            </div>
